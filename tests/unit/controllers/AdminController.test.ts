...
describe("AdminController API", () => {
  ...
  describe("POST /api/admin/users", () => {
    it("devrait créer un nouvel utilisateur avec des données valides", async () => {
      ...
      const user = await UserService.findByEmail("testuser@gmail.com");
    ...
    it("ne devrait pas créer un utilisateur avec un email non Gmail", async () => {
      ...
      expect(res.body).toHaveProperty(
        "message",
        "Seules les adresses Gmail sont autorisées."
      );
    });
  ...
  it("devrait supprimer un utilisateur", async () => {
    const user = await UserService.findByEmail("updateduser@gmail.com");
