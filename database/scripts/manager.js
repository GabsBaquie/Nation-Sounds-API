...
class DatabaseManager {
    ...
    getFullDatabaseView() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM full_db ORDER BY source");
            return result.rows;
        });
    }
    getPublicDataView() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM public_data ORDER BY source");
            return result.rows;
        });
    }
    getDatabaseStats() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM db_stats ORDER BY table_name");
            return result.rows;
        });
    }
    getPoiStatsByType() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM poi_stats_by_type ORDER BY count DESC");
            return result.rows;
        });
    }
    getConcertsByMonth() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM concerts_by_month ORDER BY month DESC");
            return result.rows;
        });
    }
    getSecurityInfoStats() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM security_info_stats ORDER BY count DESC");
            return result.rows;
        });
    }
    getRecentActivity() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM recent_activity ORDER BY created_at DESC LIMIT 10");
            return result.rows;
        });
    }
    getConcertsWithDays() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM concerts_with_days ORDER BY created_at DESC");
            return result.rows;
        });
    }
    getDaysWithConcerts() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.executeQuery("SELECT * FROM days_with_concerts ORDER BY created_at DESC");
            return result.rows;
        });
    }
}
